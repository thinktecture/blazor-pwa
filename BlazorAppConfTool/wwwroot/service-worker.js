const cacheName = 'conftool-offline-cache';
...
self.addEventListener('fetch', event => {
    if (event.request.method !== 'GET' || event.request.url.indexOf('/_framework/debug') >= 0 || event.request.url.indexOf('chrome-extension') >= 0) {
        return;
    }
